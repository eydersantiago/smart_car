...
class AvaraMixin:
    def busqueda_avara(self, inicio, objetivo):
        ...
        while cola:
            ...
            if nodo == objetivo:
                return camino, nodos_expandidos, exploracion  # Retorna camino, nodos expandidos, y exploración
        ...
        return None, nodos_expandidos, exploracion  # Si no encuentra un camino
    ...
    def busqueda_avara_total(self):
        ...
        camino1, nodos1, exploracion1 = self.busqueda_avara(self.posicion_vehiculo, self.posicion_pasajero)
        if not camino1:
        ...
        camino2, nodos2, exploracion2 = self.busqueda_avara(self.posicion_pasajero, self.destino)
        if not camino2:
